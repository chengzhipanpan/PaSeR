...
def dot_product(q_vectors, ctx_vectors):
    """
    ...
    print("I am using this now")
    return torch.dot(q_vectors, ctx_vectors)
...
def main():
    ...
    if args.mode == 'dev' or args.mode == 'fasttest':
        ...
        params['classifier'] = {'nhid': 0, 'optim': 'rmsprop', 'batch_size': 128,
                                         'tenacity': 3, 'epoch_size': 2, "similarity": dot_product}
    elif args.mode == 'test':
        # Full mode
        params = {'task_path': PATH_TO_DATA, 'usepytorch': True, 'kfold': 10}
        params['classifier'] = {'nhid': 0, 'optim': 'adam', 'batch_size': 64,
                                         'tenacity': 5, 'epoch_size': 4, "similarity": dot_product}
    else:
